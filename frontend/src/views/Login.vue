    ...
    <div class="max-w-md w-full mx-4">
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
          <div class="text-center">
            ...
            <h1 class="text-2xl font-bold text-white">EasyHolmes</h1>
            <p class="text-blue-100 text-sm mt-1">Gerenciador BPMN</p>
          </div>
        </div>
        ...
        <div class="px-8 py-8">
          ...
          <div class="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div class="flex items-start">
              ...
              <div class="ml-3">
                <h3 class="text-sm font-medium text-gray-900">Credenciais de demonstração</h3>
      ...
      <div class="mt-8 text-center">
        <p class="text-sm text-gray-500">
          © 2024 EasyHolmes. Todos os direitos reservados.
        </p>
      </div>
    </div>
  </div>
